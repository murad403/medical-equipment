...
const SellingSteps = () => {
    return (
        <div className='bg-hard py-12'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5 px-4 md:px-14 lg:px-16 mt-10'>
                {
                    sellingSteps.map(step =>
                        <div className='bg-white rounded-lg flex justify-center items-center flex-col py-5 gap-2' key={step?.id}>
                            ...
                            <p className='text-[18px] font-semibold text-title'>{step?.title}</p>
                        </div>
                    )
                }
            </div>
