...
const PolicyTemplate: React.FC<TPolicyTemplateProps> = ({policy}) => {
    ...
    return (
        <div className="">
            <div className="bg-gradient-to-l to-hard from-normal text-center py-10 md:py-14 lg:py-20 relative text-title">
                <h2 className="text-2xl md:text-3xl lg:text-3xl font-bold">{policy?.title}</h2>
            ...
            <div className="flex justify-center text-title">
